package nook.test.market_nookat.ui.fragment.edit
...
import nook.test.market_nookat.databinding.FragmentEditBinding
...
import nook.test.market_nookat.ui.fragment.profile.no_active.ads_two.AdsTwoFragment.Companion.KLO
...
class EditFragment : BaseFragment<EditViewModel,FragmentEditBinding>() {

    override val viewModel: EditViewModel by viewModel()
    override fun inflateViewBinding(inflater: LayoutInflater, container: ViewGroup?, boolean: Boolean): FragmentEditBinding {
    ...
    private fun onViewModel() {
        if (arguments != null) {
            model = arguments?.getSerializable(KLO) as AdsOne
